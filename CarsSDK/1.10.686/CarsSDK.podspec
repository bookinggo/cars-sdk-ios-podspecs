...
Pod::Spec.new do |s|
  ...
  s.source                = { :git => "https://gitlab-ci-token:gG7hBzdiwApxsepWQUH4@gitlab.booking.com/tbu/mobile/cars-sdk-ios-framework.git", :tag => '1.10.686' }

  s.vendored_frameworks   = 'CarsSDK.xcframework'
end
